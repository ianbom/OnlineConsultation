                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div class="form-group">
                        ...
                        <input id="name"
                               name="name"
                               type="text"
                               class="form-input w-full rounded-lg border-gray-300 focus:border-primary focus:ring focus:ring-primary/20"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    ...
                    <div class="form-group sm:col-span-2">
                        ...
                        <textarea id="description"
                                  name="description"
                                  rows="5"
                                  class="form-input w-full rounded-lg border-gray-300 focus:border-primary focus:ring focus:ring-primary/20 resize-none"
