...
<div class="bg-white border-b border-[#e6e0e0] top-16 z-40 shadow-sm">
    <div class="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-4">
        ...
        <div class="flex items-center gap-2 text-sm text-[#83676c] mb-3">
            ...
            <a class="hover:text-[#7b1e2d]" href="{{ route('admin.booking.index') }}">Bookings</a>
            <span class="material-symbols-outlined text-[16px]">chevron_right</span>
...
<main class="flex-grow py-8 px-4 sm:px-6 lg:px-8 max-w-[1440px] mx-auto w-full">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div class="lg:col-span-7 flex flex-col gap-6">
            <!-- Client Info Card -->
            <x-booking.client-info :client="$booking->client" :viewProfileRoute="route('admin.client.show', $booking->client->id)" />

            <!-- Counselor Info Card -->
            <x-booking.counselor-info :counselor="$booking->counselor" :viewProfileRoute="route('admin.counselor.show', $booking->counselor->id)" />
