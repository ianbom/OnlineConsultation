...
<section class="bg-white rounded-2xl border border-[#e6e0e0] shadow-sm p-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        <div class="bg-[#f8f6f6] p-4 rounded-xl border border-[#e6e0e0] text-center">
            <p class="text-xs text-[#83676c] mb-1">Tipe</p>
        ...
        <div class="bg-[#f8f6f6] p-4 rounded-xl border border-[#e6e0e0] text-center">
            <p class="text-xs text-[#83676c] mb-1">Durasi</p>
            <p class="font-bold text-[#171213] flex items-center justify-center gap-1">
                <span class="material-symbols-outlined text-[18px]">timer</span> {{ $booking->duration_hours }} Jam
            </p>
        </div>
        <div class="bg-[#f8f6f6] p-4 rounded-xl border border-[#e6e0e0] text-center">
            <p class="text-xs text-[#83676c] mb-1">Harga</p>
            <p class="font-bold text-[#7b1e2d] text-lg">Rp {{ number_format($booking->price, 0, ',', '.') }}</p>
        </div>
        <div class="bg-[#f8f6f6] p-4 rounded-xl border border-[#e6e0e0] text-center">
            <p class="text-xs text-[#83676c] mb-1">ID Booking</p>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div class="bg-[#f8f6f6] p-4 rounded-xl border border-[#e6e0e0]">
            <p class="text-xs text-[#83676c] mb-1">Status Tautan Meeting</p>
            <p class="font-medium text-[#171213]">
                ...
                @else
                <span class="text-[#83676c]">Belum Diatur</span>
                @endif
            </p>
        </div>
        <div class="bg-[#f8f6f6] p-4 rounded-xl border border-[#e6e0e0]">
            <p class="text-xs text-[#83676c] mb-1">Sudah Kedaluwarsa</p>
            <p class="font-medium text-[#171213]">
