            ...
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ltr:-ml-1 rtl:-mr-1 inline" src="/LogoPqNew.png"
                        alt="image" />
                    <span
                        class="text-xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">PersonaQuality</span>
                </a>
            ...
            <div x-data="header"
                ...
                <div class="sm:ltr:mr-auto sm:rtl:ml-auto">
                    <div class="text-sm sm:text-base font-semibold text-gray-700 dark:text-gray-200 px-4 py-2">
                        {{ \Carbon\Carbon::now()->locale('id')->translatedFormat('l, d F Y') }} | {{ auth()->user()->name }}
                    </div>
                </div>
