...
export default function CounselorsList() {
    ...
    const filteredCounselors = useMemo(() => {
        return counselors.filter((c) => {
            ...
            if (selectedSpec !== 'All' && !spec.includes(selectedSpec))
                return false;
    ...
    const activeFiltersCount =
        (selectedSpec !== 'All' ? 1 : 0) + (selectedPriceRange !== 0 ? 1 : 0);
    ...
    return (
        ...
        >
            ...
            <div className="mb-6 space-y-4">
                ...
                {/* Expand Filters */}
                {showFilters && (
                    <div className="animate-fade-in space-y-4 rounded-xl border bg-card p-4">
